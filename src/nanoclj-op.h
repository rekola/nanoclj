...
_OP_DEF("-read", "Reads a single character", OP_READ_CHAR)
...
_OP_DEF(0, 0, OP_SET0)
_OP_DEF(0, 0, OP_SET1)
_OP_DEF(0, 0, OP_WITH_REDEFS0)
_OP_DEF(0, 0, OP_WITH_REDEFS1)
_OP_DEF(0, 0, OP_WITH_REDEFS2)
_OP_DEF(0, 0, OP_WITH_OPEN0)
_OP_DEF(0, 0, OP_WITH_OPEN1)
...
_OP_DEF("-sub", 0, OP_SUB)
_OP_DEF("-sub'", 0, OP_SUBP)
_OP_DEF("-mul", 0, OP_MUL)
_OP_DEF("-mul'", 0, OP_MULP)
_OP_DEF("-div", 0, OP_DIV)
...
_OP_DEF("-write", 0, OP_WRITE)
_OP_DEF("format", 0, OP_FORMAT)
_OP_DEF("throw", 0, OP_THROW)
_OP_DEF("-close", "Closes a Reader", OP_CLOSE)
...
_OP_DEF(0, 0, OP_RD_SYNTAX_QUOTE)
_OP_DEF(0, 0, OP_RD_SYNTAX_QUOTE_VEC)
...
_OP_DEF("reset-meta!", 0, OP_RESET_META)
_OP_DEF("re-find", 0, OP_RE_FIND)
_OP_DEF("re-find-index", 0, OP_RE_FIND_INDEX)
...
_OP_DEF("refer", 0, OP_REFER)
_OP_DEF("ns", 0, OP_NS)
_OP_DEF("create-ns", 0, OP_CREATE_NS)
_OP_DEF("in-ns", 0, OP_IN_NS)
_OP_DEF("-all-ns", 0, OP_ALL_NS)
_OP_DEF("remove-ns", "Removes the namespace with the symbol x or nil", OP_REMOVE_NS)
...
_OP_DEF("set-font-face", 0, OP_SET_FONT_FACE)
