...
_OP_DEF(0, 0, OP_RDSEXPR)
_OP_DEF(0, 0, OP_RDLIST)
_OP_DEF(0, 0, OP_RDVEC_ELEMENT)
_OP_DEF(0, 0, OP_RDMAP_ELEMENT)
_OP_DEF(0, 0, OP_RDDOT)
_OP_DEF(0, 0, OP_RDQUOTE)
_OP_DEF(0, 0, OP_RDDEREF)
_OP_DEF(0, 0, OP_RDVAR)
_OP_DEF(0, 0, OP_RDQQUOTE)
_OP_DEF(0, 0, OP_RDQQUOTEVEC)
_OP_DEF(0, 0, OP_RDUNQUOTE)
_OP_DEF(0, 0, OP_RDUQTSP)
_OP_DEF(0, 0, OP_RDFN)
_OP_DEF(0, 0, OP_RDSET)
_OP_DEF(0, 0, OP_RDMAP)
